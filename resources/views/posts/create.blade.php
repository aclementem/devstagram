...
@section('contenido')
    <div class="md:flex md:items-center">
        ...
        <div class="md:w-1/2 px-10 bg-white p-10 rounder-lg shadow-xl mt-10 md:mt-0">
            <form action="{{ route('posts.store') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    <label for="descripcion" class="mb-2 block uppercase text-gray-500 font-bold">Descipción</label>
